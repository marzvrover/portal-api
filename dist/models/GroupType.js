...
var GroupType = /** @class */ (function (_super) {
    ...
    function GroupType(params) {
        var _this = _super.call(this, params) || this;
        _this.type = GroupType_1;
        (_this.type.booted || _this.type.boot());
        return _this;
    }
    GroupType_1 = GroupType;
    GroupType.boot = function () {
    ...
    GroupType.prototype.get = function (name) {
        return _super.prototype.get.call(this, name);
    };
    GroupType.prototype.set = function (name, value) {
        return _super.prototype.set.call(this, name, value);
    };
    GroupType.all = function () {
        var _this = this;
    ...
    GroupType.factory = function () {
        return new this(this.form.factory());
    };
    GroupType.prototype.validate = function () {
        return this.type.form.validate(_super.prototype.getAttributes.call(this));
    };
    var GroupType_1;
    GroupType.model_name = 'grouptype';
    GroupType.booted = false;
    GroupType = GroupType_1 = __decorate([
