...
var Attribute = /** @class */ (function (_super) {
    ...
    function Attribute(params) {
        ...
        _this.type = Attribute_1;
        (_this.type.booted || _this.type.boot());
        return _this;
    }
    Attribute_1 = Attribute;
    Attribute.boot = function () {
    ...
    Attribute.prototype.set = function (name, value) {
    ...
    Attribute.prototype.save = function () {
        return _super.prototype.save.call(this, this.type.model_name, this.type);
    };
    Attribute.create = function (attributes) {
        return __awaiter(this, void 0, void 0, function () {
            var model;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    var Attribute_1;
    Attribute.model_name = 'attribute';
    Attribute.booted = false;
