...
var Privilege = /** @class */ (function (_super) {
    ...
    Privilege.prototype.get = function (name) {
        return _super.prototype.get.call(this, name);
    };
    Privilege.prototype.set = function (name, value) {
        return _super.prototype.set.call(this, name, value);
    };
    Privilege.all = function () {
        var _this = this;
    ...
    Privilege.prototype.delete = function () {
    ...
    Privilege.factory = function () {
        return new this(this.form.factory());
    };
    Privilege.prototype.validate = function () {
        return this.type.form.validate(_super.prototype.getAttributes.call(this));
    };
    var Privilege_1;
    Privilege.model_name = 'privilege';
    Privilege.booted = false;
