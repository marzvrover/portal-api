...
var OwnerType = /** @class */ (function (_super) {
    __extends(OwnerType, _super);
    function OwnerType(params) {
        var _this = _super.call(this, params) || this;
        _this.type = OwnerType_1;
        (_this.type.booted || _this.type.boot());
        return _this;
    }
    OwnerType_1 = OwnerType;
    OwnerType.boot = function () {
    ...
    OwnerType.prototype.get = function (name) {
        return _super.prototype.get.call(this, name);
    };
    OwnerType.prototype.set = function (name, value) {
        return _super.prototype.set.call(this, name, value);
    };
    OwnerType.all = function () {
        var _this = this;
    ...
    OwnerType.prototype.delete = function () {
    ...
    OwnerType.factory = function () {
        return new this(this.form.factory());
    };
    OwnerType.prototype.validate = function () {
        return this.type.form.validate(_super.prototype.getAttributes.call(this));
    };
    var OwnerType_1;
    OwnerType.model_name = 'ownertype';
    OwnerType.booted = false;
    OwnerType = OwnerType_1 = __decorate([
